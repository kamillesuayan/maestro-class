...
class virtual_model:
    ...
    def get_batch_output(self,perturbed_tokens,labels):
        return self._process_batch(self.request_url, perturbed_tokens, labels, gradient=False)
    def get_batch_input_gradient(self,perturbed_tokens,labels):
        return self._process_batch(self.request_url, perturbed_tokens,labels, gradient=True)
