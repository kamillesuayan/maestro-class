...
def asking(url, device, student_id=123):
    data = {"Application_Name": "DataAugmentation", "data_type": "test", "id": student_id, "task": "defense_homework"}
...
def getScore(url, device, student_id=123):
    data = {"Application_Name": "GeneticAttack", "data_type": "test", "id": student_id}
