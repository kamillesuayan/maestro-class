...
from Maestro.pipeline import Pipeline, Scenario, AutoPipelineForSec
...
def test(url, device, epsilon):
    ...
    data = {"Application_Name": "Malimg", "data_type": "test"}
    ...
    # img_shape = retruned_json[0]["image"].shape
    # print()
