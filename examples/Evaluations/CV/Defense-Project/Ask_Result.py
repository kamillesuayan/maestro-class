...
def asking(url, device, student_id=123):
    ...
    data = {"Application_Name": "Project", "data_type": "test", "id": student_id, "task": "defense_project"} # Application_Name: DataAugmentation/LossFunction
...
def getScore(url, device, student_id=123):
    data = {"Application_Name": "Project", "data_type": "test", "id": student_id, "task": "defense_project"}
